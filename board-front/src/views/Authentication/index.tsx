...
export default function Authentication() {
  ...
  const SignInCard = () => {
    ...
    const onSignInButtonClickHandler = () => {
      const reqestBody: SignInRequestDto = {email, password};
      signInRequest(reqestBody).then(signInResponse);
    }
      ...
      <div className='auth-card'>
        <div className='auth-card-box'>
          <div className='auth-card-top'>
            ...
            <InputBox ref={eamilRef} label='이메일 주소' type='text' placeholder='이메일 주소를 입력해 주세요.' error={error} value={email} onChange={onEmailChangeHandler} onKeyDown={onEmailKeyDownHandler}/>
        ...
        <div className='auth-jumbotron-box'>
          <div className='auth-jumbotron-contents'>
            ...
            <div className='auth-jumbotron-text-box'>
              ...
              <div className='auth-jumbotron-text'>{'WONNI BAORD 입니다.'}</div>
            </div>
          </div>
        </div> 
