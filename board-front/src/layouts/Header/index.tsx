...
export default function Header() {
  ...
  const UploadButton = () => {
    ...
    //            event handler: 업로드 버튼 킬릭 이벤트 처리 함수      //
  ...
  useEffect(() => {
    ...
    console.log(BOARD_PATH() + '/' + BOARD_UPDATE_PATH(''));
  }, [pathname])
  //            render: 헤더 레이아웃 렌더링                    //
  return (
    <div id='header'>
      <div className='header-container'>
        <div className='header-left-box' onClick={onLogoClickHandler}>
          ...
          <div className='header-logo'>{'Wonni-blog'}</div>
        </div>
